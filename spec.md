...
- **Forget** (the primary action when `memory_forget_enabled` is on) —
  ...
  normalized text, plus — when the row had one — a copy of its embedding,
