...
export declare class MessageProcessor<T extends ComponentApi> {
     ...
     */
    constructor(catalogs: Catalog<T>[], actionHandler?: ActionListener | undefined, options?: MessageProcessorOptions);
    /**
     ...
     */
    getClientDataModel(version?: 'v0.9' | 'v0.9.1'): A2uiClientDataModel | undefined;
    /**
