...
describe('DataModel', () => {
    ...
    it('prevents prototype pollution via __proto__ in set, get, getSignal, subscribe', () => {
        assert.throws(() => model.set('/__proto__/polluted', 'hacked'), /Forbidden path segment '__proto__'/);
        assert.throws(() => model.get('/__proto__/polluted'), /Forbidden path segment '__proto__'/);
        assert.throws(() => model.getSignal('/__proto__/polluted'), /Forbidden path segment '__proto__'/);
        assert.throws(() => model.subscribe('/__proto__/polluted', () => { }), /Forbidden path segment '__proto__'/);
        assert.strictEqual({}.polluted, undefined);
    });
    it('prevents prototype pollution via constructor in set, get, getSignal, subscribe', () => {
        assert.throws(() => model.set('/constructor/prototype/polluted', 'hacked'), /Forbidden path segment 'constructor'/);
        assert.throws(() => model.get('/constructor/prototype/polluted'), /Forbidden path segment 'constructor'/);
        assert.throws(() => model.getSignal('/constructor/prototype/polluted'), /Forbidden path segment 'constructor'/);
        assert.throws(() => model.subscribe('/constructor/prototype/polluted', () => { }), /Forbidden path segment 'constructor'/);
        assert.strictEqual({}.polluted, undefined);
    });
    it('prevents prototype pollution via prototype in set, get, getSignal, subscribe', () => {
        assert.throws(() => model.set('/user/prototype/polluted', 'hacked'), /Forbidden path segment 'prototype'/);
        assert.throws(() => model.get('/user/prototype/polluted'), /Forbidden path segment 'prototype'/);
        assert.throws(() => model.getSignal('/user/prototype/polluted'), /Forbidden path segment 'prototype'/);
        assert.throws(() => model.subscribe('/user/prototype/polluted', () => { }), /Forbidden path segment 'prototype'/);
        assert.strictEqual({}.polluted, undefined);
    });
