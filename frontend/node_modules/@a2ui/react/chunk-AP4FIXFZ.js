import { createContext, memo, useMemo, Suspense, useState, useRef, useCallback, useEffect, useId, useContext, lazy } from 'react';
...
// src/v0_8/core/A2UIProvider.tsx

// src/v0_8/theme/litTheme.ts
var elementA = {
...
function ThemeProvider({ theme, children }) {
  return /* @__PURE__ */ jsx(ThemeContext.Provider, { value: theme ?? defaultTheme, children });
}
function useTheme() {
...
var markdownRenderer = new MarkdownIt();
var TAG_TO_TOKEN = {
  p: "paragraph",
  h1: "heading",
  h2: "heading",
...
var Text = memo(function Text2({ node, surfaceId }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "a2ui-text", style: hostStyle, children: /* @__PURE__ */ jsx(
    "section",
    {
...
var Image = memo(function Image2({ node, surfaceId }) {
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-image", style: hostStyle, children: /* @__PURE__ */ jsx("section", { className: classMapToString(classes), style, children: /* @__PURE__ */ jsx("img", { src: url, alt: altText || "" }) }) });
});
function toSnakeCase(str) {
  return str.replace(/([A-Z])/g, "_$1").toLowerCase();
}
var Icon = memo(function Icon2({ node, surfaceId }) {
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-icon", style: hostStyle, children: /* @__PURE__ */ jsx(
    "section",
    {
      className: classMapToString(theme.components.Icon),
      style: stylesToObject(theme.additionalStyles?.Icon),
      children: /* @__PURE__ */ jsx("span", { className: "g-icon", children: snakeCaseName })
    }
  ) });
});
var Divider = memo(function Divider2({
  node,
  surfaceId
}) {
  const { theme } = useA2UIComponent(node, surfaceId);
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-divider", style: hostStyle, children: /* @__PURE__ */ jsx(
    "hr",
    {
...
var Video = memo(function Video2({ node, surfaceId }) {
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  const url = resolveString(props.url);
  if (!url) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-video", style: hostStyle, children: /* @__PURE__ */ jsx(
    "section",
    {
      className: classMapToString(theme.components.Video),
      style: stylesToObject(theme.additionalStyles?.Video),
      children: youtubeId ? /* @__PURE__ */ jsx(
        "iframe",
        {
      ...
      ) : /* @__PURE__ */ jsx("video", { src: url, controls: true })
    }
  ) });
});
var AudioPlayer = memo(function AudioPlayer2({
  node,
  surfaceId
}) {
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-audio", style: hostStyle, children: /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("audio", { src: url, controls: true })
      ]
    }
  ) });
});
var LoadingFallback = memo(function LoadingFallback2() {
  return /* @__PURE__ */ jsx("div", { className: "a2ui-loading", style: { padding: "8px", opacity: 0.5 }, children: "Loading..." });
});
var ComponentNode = memo(function ComponentNode2({
  node,
  surfaceId,
  registry
}) {
  ...
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(LoadingFallback, {}), children: /* @__PURE__ */ jsx(Component, { node, surfaceId }) });
});
var Row = memo(function Row2({ node, surfaceId }) {
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
      ...
      children: /* @__PURE__ */ jsx(
        "section",
        {
          ...
          children: children.map((child, index) => {
            ...
            return /* @__PURE__ */ jsx(ComponentNode, { node: childNode, surfaceId }, childId);
          })
        }
      )
    }
...
var Column = memo(function Column2({
  node,
  surfaceId
}) {
  const { theme } = useA2UIComponent(node, surfaceId);
...
var List = memo(function List2({ node, surfaceId }) {
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  const direction = props.direction ?? "vertical";
  const children = Array.isArray(props.children) ? props.children : [];
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-list", "data-direction": direction, style: hostStyle, children: /* @__PURE__ */ jsx(
    "section",
    {
...
var Card = memo(function Card2({ node, surfaceId }) {
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  const rawChildren = props.children ?? (props.child ? [props.child] : []);
  const children = Array.isArray(rawChildren) ? rawChildren : [];
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-card", style: hostStyle, children: /* @__PURE__ */ jsx(
    "section",
    {
...
var Tabs = memo(function Tabs2({ node, surfaceId }) {
  const { theme, resolveString } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  const [selectedIndex, setSelectedIndex] = useState(0);
  const tabItems = props.tabItems ?? [];
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-tabs", style: hostStyle, children: /* @__PURE__ */ jsxs(
    "section",
    {
      className: classMapToString(theme.components.Tabs.container),
      style: stylesToObject(theme.additionalStyles?.Tabs),
      children: [
        /* @__PURE__ */ jsx("div", { id: "buttons", className: classMapToString(theme.components.Tabs.element), children: tabItems.map((tab, index) => {
        ...
        tabItems[selectedIndex] && /* @__PURE__ */ jsx(ComponentNode, { node: tabItems[selectedIndex].child, surfaceId })
      ]
    }
  ) });
});
var Modal = memo(function Modal2({ node, surfaceId }) {
  const { theme } = useA2UIComponent(node, surfaceId);
  const props = node.properties;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  if (!isOpen) {
    return /* @__PURE__ */ jsx("div", { className: "a2ui-modal", style: hostStyle, children: /* @__PURE__ */ jsx("section", { onClick: openModal, style: { cursor: "pointer" }, children: /* @__PURE__ */ jsx(ComponentNode, { node: props.entryPointChild, surfaceId }) }) });
  }
  return /* @__PURE__ */ jsx("div", { className: "a2ui-modal", style: hostStyle, children: /* @__PURE__ */ jsx(
    "dialog",
    {
      ref: dialogRef,
      ...
      children: /* @__PURE__ */ jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { id: "controls", children: /* @__PURE__ */ jsx("button", { onClick: closeModal, "aria-label": "Close modal", children: /* @__PURE__ */ jsx("span", { className: "g-icon", children: "close" }) }) }),
            /* @__PURE__ */ jsx(ComponentNode, { node: props.contentChild, surfaceId })
          ]
        }
      )
    }
...
var Button = memo(function Button2({
  node,
  surfaceId
}) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-button", style: hostStyle, children: /* @__PURE__ */ jsx(
    "button",
    {
      className: classMapToString(theme.components.Button),
      style: stylesToObject(theme.additionalStyles?.Button),
      onClick: handleClick,
      children: /* @__PURE__ */ jsx(ComponentNode, { node: props.child, surfaceId })
    }
  ) });
});
var TextField = memo(function TextField2({
  node,
  surfaceId
}) {
  ...
  const fieldType = propsRecord.textFieldType || propsRecord.type;
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-textfield", style: hostStyle, children: /* @__PURE__ */ jsxs("section", { className: classMapToString(theme.components.TextField.container), children: [
    label && /* @__PURE__ */ jsx("label", { htmlFor: id, className: classMapToString(theme.components.TextField.label), children: label }),
...
var CheckBox = memo(function CheckBox2({
  node,
  surfaceId
}) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-checkbox", style: hostStyle, children: /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        label && /* @__PURE__ */ jsx("label", { htmlFor: id, className: classMapToString(theme.components.CheckBox.label), children: label })
      ]
    }
  ) });
});
var Slider = memo(function Slider2({
  node,
  surfaceId
}) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-slider", style: hostStyle, children: /* @__PURE__ */ jsxs("section", { className: classMapToString(theme.components.Slider.container), children: [
    label && /* @__PURE__ */ jsx("label", { htmlFor: id, className: classMapToString(theme.components.Slider.label), children: label }),
    /* @__PURE__ */ jsx(
      "input",
      {
        type: "range",
    ...
    /* @__PURE__ */ jsx("span", { className: classMapToString(theme.components.Slider.label), children: value })
  ] }) });
});
var DateTimeInput = memo(function DateTimeInput2({
  node,
  surfaceId
}) {
  const { theme, resolveString, setValue, getValue } = useA2UIComponent(node, surfaceId);
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-datetime-input", style: hostStyle, children: /* @__PURE__ */ jsxs("section", { className: classMapToString(theme.components.DateTimeInput.container), children: [
    /* @__PURE__ */ jsx("label", { htmlFor: id, className: classMapToString(theme.components.DateTimeInput.label), children: getPlaceholderText() }),
    /* @__PURE__ */ jsx(
      "input",
      {
        type: inputType,
...
var MultipleChoice = memo(function MultipleChoice2({
  node,
  surfaceId
}) {
  ...
  const hostStyle = node.weight !== void 0 ? { "--weight": node.weight } : {};
  return /* @__PURE__ */ jsx("div", { className: "a2ui-multiplechoice", style: hostStyle, children: /* @__PURE__ */ jsxs("section", { className: classMapToString(theme.components.MultipleChoice.container), children: [
    /* @__PURE__ */ jsx("label", { htmlFor: id, className: classMapToString(theme.components.MultipleChoice.label), children: description }),
    /* @__PURE__ */ jsx(
      "select",
      {
        name: "data",
        ...
        children: options.map((option) => {
          ...
          return /* @__PURE__ */ jsx("option", { value: option.value, children: label }, option.value);
        })
      }
    )
  ] }) });
...
// src/v0_8/registry/defaultCatalog.ts
...
// src/v0_8/styles/index.ts
var structuralStyles2 = Styles.structuralStyles.replace(
  /:host\s*\{/g,
  ".a2ui-surface {"
);
...
var A2UIActionsContext = createContext(null);
var A2UIStateContext = createContext(null);
function A2UIProvider({ onAction, theme, children }) {
  ...
  return /* @__PURE__ */ jsx(A2UIActionsContext.Provider, { value: actions, children: /* @__PURE__ */ jsx(A2UIStateContext.Provider, { value: stateValue, children: /* @__PURE__ */ jsx(ThemeProvider, { theme, children }) }) });
}
...
var DefaultLoadingFallback = memo(function DefaultLoadingFallback2() {
  return /* @__PURE__ */ jsx("div", { className: "a2ui-loading", style: { padding: "16px", opacity: 0.5 }, children: "Loading..." });
});
var A2UIRenderer = memo(function A2UIRenderer2({
  surfaceId,
  className,
  fallback = null,
  loadingFallback,
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx(Suspense, { fallback: actualLoadingFallback, children: /* @__PURE__ */ jsx(ComponentNode, { node: surface.componentTree, surfaceId, registry }) })
    }
  );
});
function A2UIViewer({
  ...
  return /* @__PURE__ */ jsx(A2UIProvider, { onAction: handleAction, theme, children: /* @__PURE__ */ jsx(
    A2UIViewerInner,
    {
      surfaceId,
      root,
...
function A2UIViewerInner({
  ...
  return /* @__PURE__ */ jsx("div", { className, children: /* @__PURE__ */ jsx(A2UIRenderer, { surfaceId }) });
}
...
export { A2UIProvider, A2UIRenderer, A2UIViewer, AudioPlayer, Button, Card, CheckBox, Column, ComponentNode, ComponentRegistry, DateTimeInput, Divider, Icon, Image, List, Modal, MultipleChoice, Row, Slider, Tabs, Text, TextField, ThemeProvider, Video, classMapToString, cn, defaultTheme, initializeDefaultCatalog, litTheme, registerDefaultCatalog, stylesToObject, useA2UI, useA2UIActions, useA2UIComponent, useA2UIContext, useA2UIState, useTheme, useThemeOptional };
//# sourceMappingURL=chunk-AP4FIXFZ.js.map
//# sourceMappingURL=chunk-AP4FIXFZ.js.map