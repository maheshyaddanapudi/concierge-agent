 ...
 * ```
 */
declare function A2UIProvider({ onAction, theme, children }: A2UIProviderProps): react.JSX.Element;
/**
 ...
 * ```
 */
declare function A2UIViewer({ root, components, data, onAction, theme, className, }: A2UIViewerProps): react__default.JSX.Element;
