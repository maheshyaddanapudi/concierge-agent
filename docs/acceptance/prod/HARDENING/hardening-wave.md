# hardening wave — 2026-09-11T21:28:11Z — model openrouter:qwen/qwen3.8-max
...
$ A. the operator's wording survives a re-ingest (§3.2 description drift)
  before: {"description": "Operator: echoes the given word back \u2014 never anything else.", "source": "operator", "hash": "284bfd6ab2f7"}
...
$ A. a tool_key rename is refused on a sanitized-name collision and while a skill mentions the old key
  ...
  skill hw-drill-skill: definition v1 hash=d75b0d03b3a8
...
$ A. an MCP config edit is hashed, logged and reconnected at once
  patched: active last_connected_at 2026-09-11T21:28:14.875767Z
{"server_id": "387e1e2c-dc23-4a7b-9c35-e490a96c656b", "name": "demo-stub", "config_hash": "9ce6a5430c0f", "secrets_rotated": false, "changed_fields": ["args"], "event": "mcp_server_config_changed", "level": "warning", "timestamp": "2026-09-
{"server_id": "387e1e2c-dc23-4a7b-9c35-e490a96c656b", "tool_count": 5, "schema_changed": [], "content_changed": 0, "config_hash": "9ce6a5430c0f", "event": "mcp_tools_ingested", "level": "info", "timestamp": "2026-09-11T21:28:14.873518Z"}
  args restored
...
run 3852c0ee-dc7e-4fdd-b8ee-408bf1f0196d → completed
  ...
  cost_usd=0.006906 cost_priced=True price_snapshot={"prices": {"openrouter:qwen/qwen3.8-max": {"source": "override", "input_per_m": 1.0, "output_per_m": 2.0}}, "unpriced_tokens": 0}

$ B. the price doubles afterwards: the finished run does not move
  run cost before=0.006906 after=0.006906 price_snapshot input_per_m=1.0
